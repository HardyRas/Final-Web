<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetambwegaWardCommodities.aspx.cs" Inherits="Final_Web.GetambwegaWardCommodities" %>
...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="GetambwegaWardCommodities.aspx"><em class="fa fa-calendar">&nbsp;</em> Commodities Report</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Commodities Reports</li>
            </ol>
                            </div>
                </div>
        </div><!--/.row-->
